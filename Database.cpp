...
void Database::Initialize()
{
    ...
    m_passiveDb.clear();
    {
        m_passiveDb[PassiveType::GLOVES_BASH]           = Passive("Rabbit Punch",      Rarity::COMMON, m_animationDb["weapon_gloves"].As(0x0007, 0x0006, 0x0001),      0, 0, 0, "Your first glove swing each turn has a chance to stun the target.");
        m_passiveDb[PassiveType::GLOVES_PICKPOCKET]     = Passive("5 Finger Discount", Rarity::COMMON, m_animationDb["weapon_gloves"].As(0x0007, 0x0008, 0x0002),      1, 0, 0, "While wearing leather, glove hits have a chance to steal gold from the target.");
        m_passiveDb[PassiveType::GLOVES_BOXER]          = Passive("Boxing",            Rarity::COMMON, m_animationDb["weapon_gloves"].As(0x0007, 0x000E, 0x0003),      2, 0, 0, "Two gloves equipped: queue extra swings every turn, scaling with level.");
        m_passiveDb[PassiveType::DAGGER_DUALWIELD]      = Passive("Dual Wield",        Rarity::COMMON, m_animationDb["weapon_dagger"].As(0x0007, 0x000F, 0x0004),      3, 0, 0, "Swing both weapons when dual-wielding daggers, swords, or a mix of the two.");
        m_passiveDb[PassiveType::DAGGER_BLEED]          = Passive("Bled Dry",          Rarity::COMMON, m_animationDb["weapon_dagger"].As(0x0007, 0x0006, 0x0005),      4, 0, 0, "Your first dagger swing each turn has a chance to apply a bleeding wound.");
        m_passiveDb[PassiveType::DAGGER_MULTIATTACK]    = Passive("Nimble Fingers",    Rarity::COMMON, m_animationDb["weapon_dagger"].As(0x0007, 0x0008, 0x0006),      5, 0, 0, "Each queued dagger swing happens twice.");
        m_passiveDb[PassiveType::SWORD_PARRY]           = Passive("Parry Master",      Rarity::COMMON, m_animationDb["weapon_sword"].As(0x0007, 0x000E, 0x0007),       0, 1, 0, "While wielding a sword, you have a chance to fully negate an incoming hit.");
        m_passiveDb[PassiveType::SWORD_RIPOSTE]         = Passive("Riposte",           Rarity::COMMON, m_animationDb["weapon_sword"].As(0x0007, 0x000F, 0x0009),       1, 1, 0, "While wielding a sword, you have a chance to counter-attack with a rolled sword strike when struck.");
        m_passiveDb[PassiveType::SWORD_BATTLEWIZARD]    = Passive("Battle Wizard",     Rarity::COMMON, m_animationDb["weapon_sword"].As(0x0007, 0x0006, 0x000B),       2, 1, 0, "Wielding a sword and staff together doubles the damage of both.");
        m_passiveDb[PassiveType::GREATSWORD_HEAVYSWING] = Passive("Heavy Swing",       Rarity::COMMON, m_animationDb["weapon_great_sword"].As(0x0007, 0x0008, 0x000C), 3, 1, 0, "Great sword swings deal +(Level * Rarity) extra multi.");
        m_passiveDb[PassiveType::GREATSWORD_ALONE]      = Passive("Speciality",        Rarity::COMMON, m_animationDb["weapon_great_sword"].As(0x0007, 0x000E, 0x000D), 4, 1, 0, "Wielding only a great sword (no other weapon) doubles its multi.");
        m_passiveDb[PassiveType::GREATSWORD_HURT]       = Passive("Masochist",         Rarity::COMMON, m_animationDb["weapon_great_sword"].As(0x0007, 0x000F, 0x000E), 5, 1, 0, "Every hit you take this round adds +1 multi to your great sword's next swing.");
        m_passiveDb[PassiveType::WAND_QUICKSPELL]       = Passive("Quick Spell",       Rarity::COMMON, m_animationDb["weapon_wand"].As(0x0007, 0x0006, 0x000F),        0, 0, 1, "Wand and Staff swings act 2 speed faster.");
        m_passiveDb[PassiveType::WAND_ELEMENTALMASTER]  = Passive("Elemental Master",  Rarity::COMMON, m_animationDb["weapon_wand"].As(0x0007, 0x0008, 0x0001),        1, 0, 1, "Wand or Staff worn with Robe adds +(Level * Rarity) to multi.");
        m_passiveDb[PassiveType::WAND_FINESSE]          = Passive("Wand Finesse",      Rarity::COMMON, m_animationDb["weapon_wand"].As(0x0007, 0x000E, 0x0002),        2, 0, 1, "Each queued wand swing has a 25% chance to attack again.");
        m_passiveDb[PassiveType::STAFF_ELEMENTALMASTER] = Passive("Elemental Master",  Rarity::COMMON, m_animationDb["weapon_staff"].As(0x0007, 0x000F, 0x0003),       3, 0, 1, "Staffs deal double multi but are slower and cost extra MP per cast.");
        m_passiveDb[PassiveType::STAFF_IGNOREELEMENT]   = Passive("Potent Spells",     Rarity::COMMON, m_animationDb["weapon_staff"].As(0x0007, 0x0006, 0x0004),       4, 0, 1, "Staff attacks ignore enemy elemental resistance.");
        m_passiveDb[PassiveType::STAFF_MAGICSHIELD]     = Passive("Magical Bubble",    Rarity::COMMON, m_animationDb["weapon_staff"].As(0x0007, 0x0008, 0x0005),       5, 0, 1, "While wearing Robe + Staff, incoming damage is reduced by a rolled staff strike.");
        m_passiveDb[PassiveType::PLATE_TAUNT]           = Passive("Taunt",             Rarity::COMMON, m_animationDb["armor_plate"].As(0x0007, 0x000E, 0x0006),        0, 0, 2, "Monsters favor plate wearers when picking a single target.");
        m_passiveDb[PassiveType::PLATE_HPBOOST]         = Passive("Good Health",       Rarity::COMMON, m_animationDb["armor_plate"].As(0x0007, 0x000F, 0x0007),        1, 0, 2, "Plate wearers double the HP gained on every level up.");
        m_passiveDb[PassiveType::PLATE_IGNOREDAMAGE]    = Passive("Craftsmanship",     Rarity::COMMON, m_animationDb["armor_plate"].As(0x0007, 0x0006, 0x0009),        2, 0, 2, "Plate wearers have a chance to fully ignore incoming damage.");
        m_passiveDb[PassiveType::LEATHER_GOLD]          = Passive("Good Eye",          Rarity::COMMON, m_animationDb["armor_leather"].As(0x0007, 0x0008, 0x000A),      3, 0, 2, "Leather wearers earn (Leather Rarity * Monster Rarity) gold per kill.");
        m_passiveDb[PassiveType::LEATHER_SCOUT]         = Passive("Scout Ahead",       Rarity::COMMON, m_animationDb["armor_leather"].As(0x0007, 0x000E, 0x000B),      4, 0, 2, "Leather wearers reveal what's behind each door (1: Shop, 2: Trap, 4: Fountain/Monsters).");
        m_passiveDb[PassiveType::LEATHER_DAMAGE]        = Passive("Nimble",            Rarity::COMMON, m_animationDb["armor_leather"].As(0x0007, 0x000F, 0x000C),      5, 0, 2, "Leather + dual daggers/swords/mix: daggers and swords deal +(Level * Rarity) multi.");
