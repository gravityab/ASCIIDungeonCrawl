...
Animation Animation::As(uint16_t att1)
{
    Animation animation = *this;
    animation.SetAttributes(0, att1);
    return animation;
}

Animation Animation::As(uint16_t att1, uint16_t att2)
{
    Animation animation = *this;
    animation.SetAttributes(0, att1);
    animation.SetAttributes(1, att2);
    return animation;
}

Animation Animation::As(uint16_t att1, uint16_t att2, uint16_t att3)
{
    Animation animation = *this;
    animation.SetAttributes(0, att1);
    animation.SetAttributes(1, att2);
    animation.SetAttributes(2, att3);
    return animation;
}